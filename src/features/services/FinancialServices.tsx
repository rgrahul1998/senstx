                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                            ...
                                            <div className="border rounded-lg overflow-hidden bg-card hover:shadow-md transition-shadow">
                                                <div className="aspect-video relative bg-muted">
                                                    <img
                                                        src="/services/financial-services/credit-risk-management/business-credit-scoring-analytics.jpg"
                                                    ...
                                                    <div className="flex items-start gap-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-muted-foreground leading-relaxed">
                                                                ...
                                                                for businesses with real-time
                                                                scoring models and predictive
                                                                analytics. Our system analyzes
                                                                financial statements, payment
                                                                history, industry trends, and market
                                                                conditions to provide accurate
                                                                credit assessments. Features include
                                            ...
                                            <div className="border rounded-lg overflow-hidden bg-card hover:shadow-md transition-shadow">
                                                <div className="aspect-video relative bg-muted">
                                                    <img
                                                        src="/services/financial-services/credit-risk-management/personal-credit-evaluation-interface.jpg"
                                                    ...
                                                    <div className="flex items-start gap-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-muted-foreground leading-relaxed">
                                                                ...
                                                                assessment using advanced algorithms
                                                                and multi-factor analysis. Our
                                                                platform evaluates credit history,
                                                                income stability, debt-to-income
                                                                ratios, and behavioral patterns to
                                                                generate comprehensive credit
                                                                profiles. Includes support for
                                                                alternative data sources, thin-file
                                                                applicants, and continuous
                                                                monitoring for credit limit
                                                                adjustments.
                                                            </p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="border rounded-lg overflow-hidden bg-card hover:shadow-md transition-shadow">
                                                <div className="aspect-video relative bg-muted">
                                                    <img
                                                        src="/services/financial-services/credit-risk-management/ai-loan-default-prediction-model.jpg"
                                                ...
                                                <div className="p-5 space-y-3">
                                                    <div className="flex items-start gap-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-muted-foreground leading-relaxed">
                                                                AI-powered models to predict loan
                                                                defaults and minimize financial risk
                                                                exposure. Utilizing machine learning
                                                                and historical data, our system
                                                                identifies early warning signs of
                                                                potential defaults. Features include
                                                                risk segmentation, probability of
                                                                default calculations, loss given
                                                                default estimates, and automated
                                                                alert systems for high-risk accounts
                                            ...
                                            <div className="border rounded-lg overflow-hidden bg-card hover:shadow-md transition-shadow">
                                                <div className="aspect-video relative bg-muted">
                                                    <img
                                                        src="/services/financial-services/credit-risk-management/operational-risk-management-dashboard.jpg"
                                                    ...
                                                    <div className="flex items-start gap-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-muted-foreground leading-relaxed">
                                                                ...
                                                                your operations. Our comprehensive
                                                                framework monitors operational
                                                                processes, identifies
                                                                vulnerabilities, and recommends
                                                                corrective actions. Includes
                                                                incident tracking, risk heat maps,
                                                                control effectiveness monitoring,
                                                                and regulatory compliance checks to
                                                                ensure your operations remain secure
                                                                and efficient.
                                                            </p>
                                                        </div>
                                                    </div>
                                    ...
                                    <div className="border-t pt-6">
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                            <div className="border rounded-lg overflow-hidden bg-card hover:shadow-md transition-shadow">
                                                <div className="aspect-video relative bg-muted">
                                                    <img
                                                        src="/services/financial-services/operational-risk-management/loan-portfolio-analytics-visualization.jpg"
                                                ...
                                                <div className="p-5 space-y-3">
                                                    <div className="flex items-start gap-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-muted-foreground leading-relaxed">
                                                                Deep insights into your loan
                                                                portfolio performance with risk
                                                                concentration analysis. Track key
                                                                metrics including delinquency rates,
                                                                loss rates, and vintage analysis.
                                                                Our platform provides drill-down
                                                                capabilities to analyze performance
                                                                by segment, product type, geography,
                                                                and time period. Features include
                                                                stress testing, scenario analysis,
                                                                and what-if modeling to assess
                                                                portfolio resilience under different
                                                                market conditions.
                                                            </p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="border rounded-lg overflow-hidden bg-card hover:shadow-md transition-shadow">
                                                <div className="aspect-video relative bg-muted">
                                                    <img
                                                        src="/services/financial-services/operational-risk-management/fraud-detection-system-alert-interface.jpg"
                                                        alt="Fraud Detection"
                                                        className="w-full h-full object-cover"
                                                    />
                                                </div>
                                                    ...
                                                    <div className="flex items-start gap-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-muted-foreground leading-relaxed">
                                                                ...
                                                                suspicious activities instantly. Our
                                                                system analyzes transaction
                                                                patterns, user behavior, and network
                                                                relationships to detect anomalies.
                                                                Features include identity
                                                                verification, device fingerprinting,
                                                                transaction monitoring, and
                                                                automated case management for
                                                                investigation workflows.
                                                                Continuously updated fraud rules
                                    ...
                                    <div className="border-t pt-6">
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                            <div className="border rounded-lg overflow-hidden bg-card hover:shadow-md transition-shadow">
                                                <div className="aspect-video relative bg-muted">
                                                    <img
                                                        src="/services/financial-services/financial-analytics-reporting/automated-financial-reports-generation.jpg"
                                                ...
                                                <div className="p-5 space-y-3">
                                                    <div className="flex items-start gap-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-muted-foreground leading-relaxed">
                                                                Automated generation of financial
                                                                statements, compliance reports, and
                                                                regulatory filings. Our platform
                                                                supports multiple reporting
                                                                standards including GAAP, IFRS,
                                                                Basel III, FINRA, and SEC filings.
                                                                Features include scheduled report
                                                                generation, multi-entity
                                                                consolidation, intercompany
                                                                eliminations, and customizable
                                                                report templates with built-in
                                                                validation rules.
                                                            </p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="border rounded-lg overflow-hidden bg-card hover:shadow-md transition-shadow">
                                                <div className="aspect-video relative bg-muted">
                                                    <img
                                                        src="/services/financial-services/financial-analytics-reporting/regulatory-compliance-dashboard.jpg"
                                                    ...
                                                    <div className="flex items-start gap-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-muted-foreground leading-relaxed">
                                                                ...
                                                                with automated audit trails and
                                                                version control. Ensure data
                                                                accuracy and regulatory compliance
                                                                across all financial reporting.
                                                                Track changes, maintain historical
                                                                records, and generate compliance

                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                            <p>
                                ...
                                business success, we have grown from a small team of passionate
                                developers to a full-service software consultancy serving clients
                                worldwide.
                            </p>
                            <p>
                                Our journey has been marked by continuous innovation and a
                                commitment to staying ahead of technological trends. We've helped
                                hundreds of businesses transform their operations through
                                intelligent automation, data-driven insights, and scalable cloud
                                solutions.
                            </p>
                            <p>
                                Today, we pride ourselves on being trusted partners to organizations
                                across various industries, delivering solutions that not only meet
                                current needs but also prepare businesses for future challenges and
                                opportunities.
                            </p>
                        </div>
                    </div>
            ...
            <section className="py-20 lg:py-32">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-2xl mx-auto text-center mb-16">
                        ...
                        <p className="text-lg text-muted-foreground text-pretty">
                            Serving clients globally from our offices in New Zealand and the United
                            Kingdom
                        </p>
                    </div>

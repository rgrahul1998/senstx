  ...
  const heroServices = [
    {
      ...
      icon: BarChart3,
      image: "/financial-risk-analytics-dashboard-network.jpg",
    },
    {
      ...
      icon: Cog,
      image: "/enterprise-software-dashboard-modern.jpg",
    },
    {
      badge: "AI & Automation",
    ...
    },
    {
      ...
      icon: Database,
      image:
        "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-PeMnlOKvUtBOqD6nC35VK6oQMaj3eu.png",
    },
    {
    ...
    },
    {
      ...
      icon: Monitor,
      image: "/modern-web-application-responsive-design.jpg",
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/20">
                {(() => {
                  const Icon = heroServices[currentSlide].icon;
                  return <Icon className="w-4 h-4 text-cyan-400" />;
                })()}
                <span className="text-sm font-medium text-cyan-400">
                  {heroServices[currentSlide].badge}
                </span>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Comprehensive technology solutions spanning every stage of your
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
              ...
              to revolutionize your financial services, data analytics, and
              enterprise operations with intelligent automation and predictive
              insights.
            </p>
          </div>
              ...
              >
                <div className="p-6">
                  ...
                  <p className="text-slate-300 leading-relaxed mb-4">
                    ...
                    fraudulent transactions in real-time, and predict loan defaults
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start gap-3 text-slate-300">
                      ...
                      <span className="text-sm">
                        Automated credit scoring reducing processing time by 90%
                      </span>
                    </li>
                ...
                <div className="p-6">
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start gap-3 text-slate-300">
                      ...
                      <span className="text-sm">
                        Automated ETL pipelines with intelligent data quality checks
                      </span>
                    </li>
                    ...
                    <li className="flex items-start gap-3 text-slate-300">
                      ...
                      <span className="text-sm">
                        Natural language queries for business intelligence dashboards
                      </span>
                    </li>
                  </ul>
                ...
                <div className="p-6">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3 text-slate-300">
                      ...
                      <span className="text-sm">
                        OCR and NLP for automated invoice and document processing
                      </span>
                    </li>
                    ...
                    <li className="flex items-start gap-3 text-slate-300">
                      ...
                      <span className="text-sm">
                        Smart workflow automation reducing manual tasks by 70%
                      </span>
                    </li>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-12 border-t border-slate-700">
            ...
            <div className="text-center">
              ...
              <p className="text-slate-300 text-sm">
                Fraud Prevented with ML Models
              </p>
            </div>
            <div className="text-center">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Partner with experts who understand your business challenges and
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">
                Decades of combined experience delivering enterprise-grade
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">
                Custom-built software designed specifically for your unique
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">
                Continuous optimization and support to ensure your solutions
                deliver maximum ROI
              </p>
            </div>
          </div>
